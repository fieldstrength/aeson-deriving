...
instance (ToJSON a, ToConstantObject obj) => ToJSON (WithConstantFields obj a) where
...
instance (FromJSON a, ToConstantObject obj) => FromJSON (WithConstantFields obj a) where
